...
const affiliateProducts = [
  {
    ...
    rating: 4.8,
    reviews: 2847,
    image: "/resistance-bands-set-with-handles-and-door-anchor.jpg",
    ...
    badge: "Best Seller",
    affiliate: "Amazon",
    affiliateUrl: "https://amzn.to/3ID5nEE",
  },
  {
    id: 2,
    ...
    rating: 4.6,
    reviews: 1523,
    image: "/adjustable-dumbbells-black-weight-set.jpg",
    description: "Space-efficient dumbbells that replace an entire weight set. Quick weight changes from 5-25 lbs.",
    pros: ["Saves space", "Quick adjustments", "Durable construction"],
    badge: "Editor's Choice",
    affiliate: "Amazon",
    affiliateUrl: "https://amzn.to/48Caorw",
  },
  {
    id: 3,
    ...
    rating: 4.7,
    reviews: 3241,
    image: "/thick-yoga-mat-purple-non-slip-exercise-mat.jpg",
    ...
    badge: "Top Rated",
    affiliate: "Amazon",
    affiliateUrl: "https://amzn.to/3IwSKuT",
  },
  {
    id: 4,
    ...
    rating: 4.5,
    reviews: 987,
    image: "/speed-jump-rope-adjustable-handles-cardio.jpg",
    description: "Adjustable speed rope with comfortable handles and smooth ball bearings for cardio workouts.",
    pros: ["Burns calories fast", "Improves coordination", "Compact storage"],
    badge: "Cardio King",
    affiliate: "Amazon",
    affiliateUrl: "https://amzn.to/3VtkhAl",
  },
]
